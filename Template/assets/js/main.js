  ...
  /------------------------------------------------------*/
	...
	$(document).ready(function ($) {
		...
		$(window).scroll(function () {
			...
			// console.log(scroll, "scrollscrollscroll")
			if (scroll > 50) {
				$(".tj-header-area").addClass("bg-show");
				// $(".tj-header-area").removeClass("bg-transparent");
			}
			else {
				// $(".tj-header-area").addClass("bg-transparent");
				$(".tj-header-area").removeClass("bg-show");
				// $(".tj-header-area").removeClass("sticky");
			}
